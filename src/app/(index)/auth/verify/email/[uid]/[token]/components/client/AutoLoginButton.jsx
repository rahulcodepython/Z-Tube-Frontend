...
const AutoLoginButton = () => {
    ...
    return loading ? <button disabled type="button" className="text-white bg-black font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
        ...
        <Link href={'/'} className='px-4 py-2 rounded-lg bg-green-600 text-white'>
            Enjoy your feed
        </Link> : <Link href={'/auth/login'} className='px-4 py-2 rounded-lg bg-green-600 text-white'>
            Go to Login
        </Link>
