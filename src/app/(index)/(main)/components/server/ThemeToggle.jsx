...
import { MdOutlineWbSunny, BsMoonStars } from '@/data/icons/icons'
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="outline" size="icon" className="outline-none border-none hover:bg-transparent shadow-none focus:ring-0 focus-visible:ring-0">
