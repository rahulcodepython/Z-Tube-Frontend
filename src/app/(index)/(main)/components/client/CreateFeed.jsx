...
const CreateFeed = ({setIsOpen}) => {
    ...
    return (
        <Formik initialValues={{
            ...
            async values => await CreateFeedPost(setUploading, accessToken, media, values, tags, setIsOpen)
        }>
...
const CreateFeedPost = async (setUploading, accessToken, media, values, tags, setIsOpen) => {
    if (media.length > 0) {
        setUploading(() => true)
