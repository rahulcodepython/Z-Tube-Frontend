...
const CreateFeed = ({setIsOpen}) => {
    ...
    return <Formik initialValues={{
        ...
        allowComments: false
                   ...
                   onSubmit={async values => await CreateFeedPost(setUploading, accessToken, media, values, setIsOpen)}>
...
const CreateFeedPost = async (setUploading, accessToken, media, values, setIsOpen) => {
    if (media.length > 0) {
        setUploading(() => true)
