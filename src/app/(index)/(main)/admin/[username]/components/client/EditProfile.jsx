                ...
                <form onSubmit={(e) => { e.preventDefault() }} onKeyDown={(e) => {
                            ...
                            <div className="col-span-1">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <div className='w-full flex gap-2 justify-center items-center'>
                                        <Input type="text" name="username" id="username" value={profileData?.username} onChange={async (e) => await CheckUser(e, profileData, setIsUsernameValid, formData, accessToken, setFormData)}
                                            className="focus:outline-none focus:ring-0 focus-visible:ring-0" />
                    ...
                    </div>
                    {
                        isUpdating ? <Button disabled>
                            ...
                            <Button type='submit' onClick={async () => await UpdateProfile(isAuthenticated, isAccessToken, accessToken, isUserImageChange, isBannerImageChange, userImage, bannerImage, setIsProfileData, setProfileData, setIsUserData, setUserData, setProfile, router, onModalClose, setIsUpdating)}>
                                Update
                            </Button>
                    }
                </form>
